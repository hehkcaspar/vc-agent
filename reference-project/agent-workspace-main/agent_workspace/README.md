# Agentic Workspace Processor — Core Module

The domain-agnostic core engine. Accepts text instructions, scans and reasons about resources, then produces persistent artifacts. This module is designed to be stable and rarely changed — application-specific behavior lives in shell apps under `apps/`.
